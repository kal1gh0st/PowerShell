...
#Create a CSV report with all the installed software
$ReportFileName = "InstalledSoftware-$($env:COMPUTERNAME)-$(Get-Date -Format "yyyyMMdd").csv" #Read-Host -Prompt "Report Name (e.g. mypc.csv)"
Get-InstalledSoftware | Export-csv $ReportFileName -NoTypeInformation
